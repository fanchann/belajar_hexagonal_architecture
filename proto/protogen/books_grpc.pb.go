...
type BookServiceClient interface {
	CreateBook(ctx context.Context, in *BookCreateRequest, opts ...grpc.CallOption) (*Empty, error)
	UpdateBook(ctx context.Context, in *BookUpdateRequest, opts ...grpc.CallOption) (*Empty, error)
	GetBook(ctx context.Context, in *BookGetRequest, opts ...grpc.CallOption) (*BookResponse, error)
	DeleteBook(ctx context.Context, in *BookDeleteRequest, opts ...grpc.CallOption) (*Empty, error)
	GetAllBooks(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*BookListResponse, error)
}
...
func (c *bookServiceClient) CreateBook(ctx context.Context, in *BookCreateRequest, opts ...grpc.CallOption) (*Empty, error) {
...
func (c *bookServiceClient) UpdateBook(ctx context.Context, in *BookUpdateRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
...
func (c *bookServiceClient) GetBook(ctx context.Context, in *BookGetRequest, opts ...grpc.CallOption) (*BookResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *bookServiceClient) DeleteBook(ctx context.Context, in *BookDeleteRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
...
func (c *bookServiceClient) GetAllBooks(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*BookListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type BookServiceServer interface {
	CreateBook(context.Context, *BookCreateRequest) (*Empty, error)
	UpdateBook(context.Context, *BookUpdateRequest) (*Empty, error)
	GetBook(context.Context, *BookGetRequest) (*BookResponse, error)
	DeleteBook(context.Context, *BookDeleteRequest) (*Empty, error)
	GetAllBooks(context.Context, *Empty) (*BookListResponse, error)
...
func (UnimplementedBookServiceServer) CreateBook(context.Context, *BookCreateRequest) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateBook not implemented")
}
func (UnimplementedBookServiceServer) UpdateBook(context.Context, *BookUpdateRequest) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateBook not implemented")
}
func (UnimplementedBookServiceServer) GetBook(context.Context, *BookGetRequest) (*BookResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetBook not implemented")
}
func (UnimplementedBookServiceServer) DeleteBook(context.Context, *BookDeleteRequest) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteBook not implemented")
}
func (UnimplementedBookServiceServer) GetAllBooks(context.Context, *Empty) (*BookListResponse, error) {
...
func _BookService_GetBook_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BookServiceServer).GetBook(ctx, req.(*BookGetRequest))
	}
	return interceptor(ctx, in, info, handler)
}
